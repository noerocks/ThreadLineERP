  ...
  return (
    <div>
      <div className="flex items-center py-4">
        <Input
          placeholder="Filter supplier names..."
          value={
            (table.getColumn("supplier.name")?.getFilterValue() as string) ?? ""
          }
          onChange={(event) =>
            table.getColumn("supplier.name")?.setFilterValue(event.target.value)
          }
          className="max-w-sm"
        />
        <DropdownMenu>
